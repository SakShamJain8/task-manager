...
export default function SignupOtp() {
  ...
  const handleDetailsSubmit = async e => {
    ...
    setServerError('')
    try {
      const response = await authApi.requestSignupOtp({ email: form.email, purpose: 'signup' })
    ...
    <div className="auth-page">
      <div className="auth-card">
        ...
        <p className="auth-subtitle">
          {step === 1 
            ? 'Join our workspace and collaborate with your team'
            ...
            <div className="form-group">
              ...
              {form.password && (
                <div className="password-strength">
                  ...
                  <span className={`strength-text ${strengthClasses[strength]}`}>
        ...
        <div className="auth-footer">
          ...
          <Link to="/login-otp">Sign in</Link>
        </div>
      </div>
    </div>
  )
